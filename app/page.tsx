      ...
      <div className="w-full md:w-2/3 flex flex-col gap-8 rotate-[1deg]">
        ...
        <div className="dossier-card p-dossier-padding">
          ...
          <h1 className="font-headline-lg-mobile md:font-headline-lg text-primary mb-6 border-b-2 border-outline pb-4 flex items-center justify-between">
            ...
            <span className="material-symbols-outlined text-4xl opacity-50">badge</span>
          </h1>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 font-body-md text-body-md text-on-surface-variant mb-8">
            <div className="border-l-2 border-surface-tint pl-4">
              <div className="font-label-sm text-label-sm text-primary opacity-70 mb-1">ALIAS / NAME</div>
              <div className="font-bold text-on-surface uppercase">Shravan Shashi Jain</div>
            </div>
            <div className="border-l-2 border-surface-tint pl-4">
              <div className="font-label-sm text-label-sm text-primary opacity-70 mb-1">PRIMARY LOCATION</div>
              <div className="font-bold text-on-surface uppercase">Vellore Institute of Technology</div>
            </div>
          ...
          <div className="bg-surface-container-lowest p-4 border border-outline-variant text-body-md font-body-md">
            <p className="mb-4">
              Subject demonstrates a relentless passion for problem-solving, with a strong interest in Machine Learning and full-stack development. Driven by curiosity and the challenge of turning complex problems into practical, scalable solutions.
            </p>
            <p>
              WARNING: Subject is known to pursue difficult problems beyond the obvious solution. Highly engaged in learning, experimenting, and engineering systems across the ML and software development spectrum.
        ...
        <div className="dossier-card p-dossier-padding relative">
          <div className="absolute -left-2 top-8 w-24 h-6 bg-secondary-container text-on-secondary-container font-label-sm flex items-center justify-center rotate-[-90deg] border border-[#333333] shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">
            EVIDENCE TAG
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 ml-6">
            <div className="flex items-center gap-3 bg-surface-container p-3 border border-outline-variant hover:bg-surface-bright transition-colors glitch-hover cursor-default">
              ...
              <span className="font-label-md text-label-md text-on-surface">PROBLEM SOLVING / DSA</span>
            </div>
            <div className="flex items-center gap-3 bg-surface-container p-3 border border-outline-variant hover:bg-surface-bright transition-colors glitch-hover cursor-default">
              <span className="material-symbols-outlined text-tertiary-container">code</span>
              <span className="font-label-md text-label-md text-on-surface">WEB TECHNOLOGIES</span>
            </div>
            <div className="flex items-center gap-3 bg-surface-container p-3 border border-outline-variant hover:bg-surface-bright transition-colors glitch-hover cursor-default">
              <span className="material-symbols-outlined text-tertiary-container">database</span>
              <span className="font-label-md text-label-md text-on-surface">SYSTEMS & DEPLOYMENT</span>
            </div>
            <div className="flex items-center gap-3 bg-surface-container p-3 border border-outline-variant hover:bg-surface-bright transition-colors glitch-hover cursor-default">
              <span className="material-symbols-outlined text-tertiary-container">rocket_launch</span>
              <span className="font-label-md text-label-md text-on-surface">MACHINE LEARNING</span>
            </div>
          </div>
        </div>
