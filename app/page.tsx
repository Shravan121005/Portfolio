  ...
  return (
    <main className="flex flex-col md:flex-row gap-12 items-start justify-center w-full">
      ...
      >
        ...
        {/* Action Area — Contact + Profile CTA */}
        <motion.div
          className="flex flex-col sm:flex-row gap-3 justify-start md:justify-end mt-4"
          variants={fadeUp}
          transition={{ ...transitionBase, delay: 0.2 }}
        >
          {/* Primary: view technical profile */}
          <Link
            href="/profile"
            className="bg-primary-container text-on-primary-container font-label-md text-label-md px-6 py-3 font-bold border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] btn-sweep flex items-center justify-center gap-2 cursor-pointer w-full sm:w-auto text-center hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[2px] hover:translate-y-[2px] transition-all duration-150"
          >
