...
import { Courier_Prime, Anybody, JetBrains_Mono } from "next/font/google";
import "./globals.css";
...
export default function RootLayout({
  ...
  return (
    <html
      lang="en"
      className={`dark ${courierPrime.variable} ${anybody.variable} ${jetbrainsMono.variable} h-full antialiased`}
    >
      <head>
